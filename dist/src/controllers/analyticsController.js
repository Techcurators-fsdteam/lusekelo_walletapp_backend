...
exports.getTransactionTrends = exports.getCategoryBreakdown = exports.getAnalytics = void 0;
...
exports.getTransactionTrends = getTransactionTrends;
function getCategoryFromType(type, description) {
    const descLower = description.toLowerCase();
    if (descLower.includes('salary') || descLower.includes('income'))
        return 'Salary';
    if (descLower.includes('food') || descLower.includes('restaurant') || descLower.includes('drink'))
        return 'Food & Drink';
    if (descLower.includes('shopping') || descLower.includes('purchase'))
        return 'Shopping';
    if (descLower.includes('internet') || descLower.includes('wifi') || descLower.includes('data'))
        return 'Internet';
    if (descLower.includes('wallet') || descLower.includes('deposit'))
        return 'E-Wallet';
    if (descLower.includes('transport') || descLower.includes('taxi') || descLower.includes('bus'))
        return 'Transport';
    if (descLower.includes('bill') || descLower.includes('utility'))
        return 'Bills';
    if (descLower.includes('entertainment') || descLower.includes('movie'))
